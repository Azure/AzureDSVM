...
#'   "CentOS", "Windows", and "DeepLearning". The default is to deploy
#'   a Ubuntu Linux Data Science Virtual Machine. NOTE Deep learning
#'   DSVM is still Windows based but there is an extension which
#'   preinstalls GPU related drivers and libraries.
#'
