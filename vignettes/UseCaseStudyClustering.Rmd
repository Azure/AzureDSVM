...
The script can then be saved and later on path to the script is used as reference. For example, in this demo, the script is saved with name "worker_cluster.R" which is located in the "/test" directory.
